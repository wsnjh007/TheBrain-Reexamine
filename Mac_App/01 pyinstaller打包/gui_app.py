...
# 使用 os.path.join 动态获取每个脚本的完整路径
fupan_path = os.path.join(base_path, 'fupan.py')
anki_path = os.path.join(base_path, 'anki.py')
flomo_path = os.path.join(base_path, 'flomo.py')
anki_sync_mac_path = os.path.join(base_path, 'anki_sync_mac.sh')
# 动态获取 TB_rul.txt 的路径
tb_rul_path = os.path.join(base_path, 'TB_rul.txt')
# 动态获取 config_mr.txt 和 config.py 的路径
config_mr_path = os.path.join(base_path, 'config_mr.txt')
config_py_path = os.path.join(base_path, 'config.py')
